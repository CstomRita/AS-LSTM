...
from train_01.layers.attention import NoQueryAttention
from train_01.layers import DynamicRNN
import torch
import torch.nn as nn

from train_01.layers.squeeze_embedding import SqueezeEmbedding
...
class ATAE_LSTM(nn.Module):
    def __init__(self, embedding_matrix, opt):
        ...
        self.lstm = DynamicRNN(opt.embed_dim*2, opt.hidden_dim, num_layers=1, batch_first=True)
