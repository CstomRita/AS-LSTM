...
if __name__=='__main__':
    ...
    split.sentence_split("../data/nlpcc2014/data_emoji_split_hasEmoji/train_data.json",True)

    test_xml_path = "../data/nlpcc2014/EmotionClassficationTest.xml"
    split = SentenceSplit(test_xml_path)
    split.sentence_split("../data/nlpcc2014/data_emoji_split_hasEmoji/test_data.json", False)
